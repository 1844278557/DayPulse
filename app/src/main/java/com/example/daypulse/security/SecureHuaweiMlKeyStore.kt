...
/** Stores the Huawei ML Kit API key locally using Android Keystore AES/GCM encryption. */
class SecureHuaweiMlKeyStore(context: Context) {
    private val prefs = context.getSharedPreferences("secure_huawei_ml", Context.MODE_PRIVATE)
    private val alias = "daypulse_huawei_ml_key"
